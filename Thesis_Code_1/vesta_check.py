...
ax1.set_title("Maximum Stable Droplet Radius vs. Dynamic Viscosity (Vesta)")
...
ax2.set_title("Stable Settling Velocity vs. Dynamic Viscosity (Vesta)")
...
ax3.set_title("Stable Settling Velocity vs. Stable Droplet Radius (Vesta)")
...
ax4.set_title("Friction Coefficient (f) vs. Dynamic Viscosity for Possible Droplet Radius (Vesta)")
...
print(radius_turbulent_list, z_eq_turbulent_list)
