...
ax17.plot(depth_vesta_1, [i * (10**-9) * vesta_droplet_mass * num_droplets_vesta for i in mass_conc_droplet_vesta_1_time1])
ax17.plot(depth_vesta_1, [i * (10**-9) * vesta_droplet_mass * num_droplets_vesta for i in mass_conc_droplet_vesta_1_time5])
...
ax17.axhline(modeled_mass_w182_in_vesta_core, color='black', linestyle="--", label="Modeled Mass $^{182}$W in Vesta Core")
ax17.grid()
ax17.set_xlabel("Depth (km)")
ax17.set_ylabel("Mass (kg)")
ax17.set_title(("Mass of $^{182}$W Transported to Vesta's Core by Iron Rain (N=%s) (Vesta Model 1)" % num_droplets_vesta))
ax17.legend(loc='upper left')

fig18 = plt.figure()
ax18 = fig18.add_subplot(111)
ax18.plot(depth_vesta_2, [i * (10**-9) * vesta_droplet_mass * num_droplets_vesta for i in mass_conc_droplet_vesta_2_time1])
ax18.plot(depth_vesta_2, [i * (10**-9) * vesta_droplet_mass * num_droplets_vesta for i in mass_conc_droplet_vesta_2_time5])
...
ax18.axhline(modeled_mass_w182_in_vesta_core, color='black', linestyle="--", label="Modeled Mass $^{182}$W in Vesta Core")
ax18.grid()
ax18.set_xlabel("Depth (km)")
ax18.set_ylabel("Mass (kg)")
ax18.set_title(("Mass of $^{182}$W Transported to Vesta's Core by Iron Rain (N=%s) (Vesta Model 2)" % num_droplets_vesta))
ax18.legend(loc='upper left')

fig19 = plt.figure()
ax19 = fig19.add_subplot(111)
ax19.plot(depth_vesta_3, [i * (10**-9) * vesta_droplet_mass * num_droplets_vesta for i in mass_conc_droplet_vesta_3_time1])
ax19.plot(depth_vesta_3, [i * (10**-9) * vesta_droplet_mass * num_droplets_vesta for i in mass_conc_droplet_vesta_3_time5])
...
ax19.axhline(modeled_mass_w182_in_vesta_core, color='black', linestyle="--", label="Modeled Mass $^{182}$W in Vesta Core")
ax19.grid()
ax19.set_xlabel("Depth (km)")
ax19.set_ylabel("Mass (kg)")
ax19.set_title(("Mass of $^{182}$W Transported to Vesta's Core by Iron Rain (N=%s) (Vesta Model 3)" % num_droplets_vesta))
ax19.legend(loc='upper left')

fig20 = plt.figure()
ax20 = fig20.add_subplot(111)
ax20.plot(depth_vesta_4, [i * (10**-9) * vesta_droplet_mass * num_droplets_vesta for i in mass_conc_droplet_vesta_4_time1])
ax20.plot(depth_vesta_4, [i * (10**-9) * vesta_droplet_mass * num_droplets_vesta for i in mass_conc_droplet_vesta_4_time5])
...
ax20.axhline(modeled_mass_w182_in_vesta_core, color='black', linestyle="--", label="Modeled Mass $^{182}$W in Vesta Core")
ax20.grid()
ax20.set_xlabel("Depth (km)")
ax20.set_ylabel("Mass (kg)")
ax20.set_title(("Mass of $^{182}$W Transported to Vesta's Core by Iron Rain (N=%s) (Vesta Model 4)" % num_droplets_vesta))
ax20.legend(loc='upper left')

fig21 = plt.figure()
ax21 = fig21.add_subplot(111)
ax21.plot(depth_vesta_5, [i * (10**-9) * vesta_droplet_mass * num_droplets_vesta for i in mass_conc_droplet_vesta_5_time1])
ax21.plot(depth_vesta_5, [i * (10**-9) * vesta_droplet_mass * num_droplets_vesta for i in mass_conc_droplet_vesta_5_time5])
...
ax21.axhline(modeled_mass_w182_in_vesta_core, color='black', linestyle="--", label="Modeled Mass $^{182}$W in Vesta Core")
ax21.grid()
ax21.set_xlabel("Depth (km)")
ax21.set_ylabel("Mass (kg)")
ax21.set_title(("Mass of $^{182}$W Transported to Vesta's Core by Iron Rain (N=%s) (Vesta Model 5)" % num_droplets_vesta))
ax21.legend(loc='upper left')

fig22 = plt.figure()
ax22 = fig22.add_subplot(111)
ax22.plot(depth_vesta_6, [i * (10**-9) * vesta_droplet_mass * num_droplets_vesta for i in mass_conc_droplet_vesta_6_time1])
ax22.plot(depth_vesta_6, [i * (10**-9) * vesta_droplet_mass * num_droplets_vesta for i in mass_conc_droplet_vesta_6_time5])
...
ax22.axhline(modeled_mass_w182_in_vesta_core, color='black', linestyle="--", label="Modeled Mass $^{182}$W in Vesta Core")
ax22.grid()
ax22.set_xlabel("Depth (km)")
ax22.set_ylabel("Mass (kg)")
ax22.set_title(("Mass of $^{182}$W Transported to Vesta's Core by Iron Rain (N=%s) (Vesta Model 6)" % num_droplets_vesta))
ax22.legend(loc='upper left')

fig23 = plt.figure()
ax23 = fig23.add_subplot(111)
ax23.plot(depth_vesta_7, [i * (10**-9) * vesta_droplet_mass * num_droplets_vesta for i in mass_conc_droplet_vesta_7_time1])
ax23.plot(depth_vesta_7, [i * (10**-9) * vesta_droplet_mass * num_droplets_vesta for i in mass_conc_droplet_vesta_7_time5])
...
ax23.axhline(modeled_mass_w182_in_vesta_core, color='black', linestyle="--", label="Modeled Mass $^{182}$W in Vesta Core")
ax23.grid()
ax23.set_xlabel("Depth (km)")
ax23.set_ylabel("Mass (kg)")
ax23.set_title(("Mass of $^{182}$W Transported to Vesta's Core by Iron Rain (N=%s) (Vesta Model 7)" % num_droplets_vesta))
ax23.legend(loc='upper left')

fig24 = plt.figure()
ax24 = fig24.add_subplot(111)
ax24.plot(depth_vesta_8, [i * (10**-9) * vesta_droplet_mass * num_droplets_vesta for i in mass_conc_droplet_vesta_8_time1])
ax24.plot(depth_vesta_8, [i * (10**-9) * vesta_droplet_mass * num_droplets_vesta for i in mass_conc_droplet_vesta_8_time5])
...
ax24.axhline(modeled_mass_w182_in_vesta_core, color='black', linestyle="--", label="Modeled Mass $^{182}$W in Vesta Core")
ax24.grid()
ax24.set_xlabel("Depth (km)")
ax24.set_ylabel("Mass (kg)")
ax24.set_title(("Mass of $^{182}$W Transported to Vesta's Core by Iron Rain (N=%s) (Vesta Model 8)" % num_droplets_vesta))
